...
export default (svg, dimensions, scales, configuration) => {
    ...
    const chartContainer = svg.append('g')
        ...
        .attr('transform', `translate(${configuration.labelsWidth + configuration.labelsRightMargin}, 55)`);
    ...
    const lineSeparator = lineSeparatorFactory(scales, configuration, dimensions);
