...
function eventDrops(config = {}) {
    ...
    function eventDropGraph(selection) {
        selection.each(function selector(data) {
            ...
            const xScaleFinal = finalConfiguration.customXAxis ?
                finalConfiguration.customXAxis.xScale(dimensions.width)
                : xScale(dimensions.width, [finalConfiguration.start, finalConfiguration.end]);
